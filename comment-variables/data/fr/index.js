        ...
        defs: {
          utils: {
            public: {
              ...
              treatVSCodeErrors:
                "Affiche un nombre défini d'erreurs via la méthode `vscode.window.showErrorMessage` par le biais de l'utilitaire `$COMMENT#EN#COMPOSEDVARIABLESEXCLUSIVES#RUNTIMEVARIABLES#NAMES#FUNCTIONS#SHOWVSCODEERROR`." /* variations: $COMMENT#TSDOC#SRC#LIB#DEFS#UTILS#PUBLIC#TREATVSCODEERRORS / core: $COMMENT#FR#TSDOC#SRC#LIB#DEFS#UTILS#PUBLIC#TREATVSCODEERRORS */,
              logCLIError:
