...
export const resolvedPublicData = /** @type {const} */ ({
  ...
  "libraryVariations": {
    "EN": {
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#COMVAR#ITEMS#PUBLIC#ERROR_NOT_STANDARDIZED_STATUS": "\"The error encountered is not standardized.\"",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#DEFS#UTILS#PUBLIC#TREATVSCODEERRORS": "Displays a set amount of errors via the `vscode.window.showErrorMessage` method (through the `showVSCodeError` utility).",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#PARAMS#UTILS#PUBLIC#ERRORS": "The array of errors to be displayed.",
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#PARAMS#UTILS#PUBLIC#NUMBEROFERRORS": "The number of errors to be displayed, instantiated at `3` by default to match the maximum amount of error messages VS Code displays simultaneously.",
      ...
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#MESSAGES#ERRORNOTSTANDARDIZED": "The error encountered is not standardized.",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#STATUSES#ERRORNOTSTANDARDIZED": "ERROR_NOT_STANDARDIZED",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#DEFAULTS#NUMBEROFERRORS": "3",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#STRINGS#ERRORNOTSTANDARDIZEDMESSAGE": "ERROR_NOT_STANDARDIZED_MESSAGE",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#STRINGS#ERRORNOTSTANDARDIZEDSTATUS": "ERROR_NOT_STANDARDIZED_STATUS",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#OBJECTS#SUCCESSFALSE": "successFalse",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#OBJECTS#SUCCESSTRUE": "successTrue",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#OBJECTS#TYPEERROR": "typeError",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#OBJECTS#TYPEWARNING": "typeWarning",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#MAKESUCCESSFALSETYPEERROR": "makeSuccessFalseTypeError",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#MAKESUCCESSFALSETYPEWARNING": "makeSuccessFalseTypeWarning",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#MAKEERRORTYPEERROR": "makeErrorTypeError",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#MAKEERRORTYPEWARNING": "makeErrorTypeWarning",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#SHOWVSCODEERROR": "showVSCodeError",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#TREATVSCODEERRORS": "treatVSCodeErrors",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#LOGCLIERROR": "logCLIError",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#ESCAPEREGEX": "escapeRegex",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#TRIMSTRINGWITHLIMIT": "trimStringWithLimit",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#SPACEOUTESLINTMESSAGE": "spaceOutESLintMessage",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#HIGHLIGHTFIRSTLINEOFCODE": "highlightFirstLineOfCode",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#PATHEXISTSASAFILE": "pathExistsAsAFile",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#FUNCTIONS#PATHEXISTSASADIRECTORY": "pathExistsAsADirectory",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#NOTRUNTIMEVARIABLES#PUBLIC#SUCCESS_FALSE": "success: false",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#NOTRUNTIMEVARIABLES#PUBLIC#SUCCESS_TRUE": "success: true",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#NOTRUNTIMEVARIABLES#PUBLIC#ATHAND": "at hand",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#RETURNS#UTILS#PUBLIC#TREATVSCODEERRORS": "Void.",
      ...
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#TYPES#ERROR": "error",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#TYPES#WARNING": "warning",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#ARGUMENTS#MESSAGE": "message",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#ARGUMENTS#STATUS": "status",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#PROPERTIES#SUCCESS": "success",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#PROPERTIES#TYPE": "type",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#IDENTIFIERS#PROPERTIES#ERRORS": "errors",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#NOTRUNTIMEVARIABLES#SUCCESS_FALSE": "success: false",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#NOTRUNTIMEVARIABLES#SUCCESS_TRUE": "success: true",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#NOTRUNTIMEVARIABLES#ATHAND": "at hand",
      ...
      "_LUTHERTS_ERROR_HANDLING#PUBLIC#TREATVSCODEERRORS": "",
      ...
      "_LUTHERTS_ERROR_HANDLING#PUBLIC#ERROR_NOT_STANDARDIZED_MESSAGE": "",
      "_LUTHERTS_ERROR_HANDLING#PUBLIC#ERROR_NOT_STANDARDIZED_STATUS": "",
      "_LUTHERTS_ERROR_HANDLING#PUBLIC#ATHANDTEMPLATEFUNCTION": ""
    },
    "FR": {
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#COMVAR#ITEMS#PUBLIC#ERROR_NOT_STANDARDIZED_STATUS": "En anglais à l'exécution : \"The error encountered is not standardized.\"",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#DEFS#UTILS#PUBLIC#TREATVSCODEERRORS": "Affiche un nombre défini d'erreurs via la méthode `vscode.window.showErrorMessage` par le biais de l'utilitaire `showVSCodeError`.",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#PARAMS#UTILS#PUBLIC#ERRORS": "La liste des erreurs qui doivent être affichées.",
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#PARAMS#UTILS#PUBLIC#NUMBEROFERRORS": "Le nombre d'erreurs à afficher, instantié à `3` par défaut en accord avec le nombre maximum de messages d'erreur que VS Code peut afficher simultanément.",
      ...
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#NOTRUNTIMEVARIABLES#PUBLIC#ATHAND": "concerné(e)(s)",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#DEFS#UTILS#PUBLIC#MAKEERRORTYPEERROR": "Crée un objet d'erreur de `{type: error}` dont l'erreur est basée sur le `message` qu'elle doit montrer et sur le `status` qu'elle doit avoir.",
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#DEFS#UTILS#PUBLIC#MAKEERRORTYPEWARNING": "Crée un objet d'erreur de `{type: warning}` dont l'erreur est basée sur le `message` qu'elle doit montrer et sur le `status` qu'elle doit avoir.",
      ...
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#RETURNS#UTILS#PUBLIC#TREATVSCODEERRORS": "Void. (Aucun retour.)",
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#RETURNS#UTILS#PUBLIC#LOGCLIERROR": "Void. (Aucun retour.)",
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#RETURNS#UTILS#PUBLIC#PATHEXISTSASAFILE": "`true` si le chemin est un fichier, `false` le cas échéant.",
      "_LUTHERTS_ERROR_HANDLING#TSDOC#SRC#LIB#RETURNS#UTILS#PUBLIC#PATHEXISTSASADIRECTORY": "`true` si le chemin est un dossier, `false` le cas échéant.",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#MESSAGES#ERRORNOTSTANDARDIZED": "The error encountered is not standardized.",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#STATUSES#ERRORNOTSTANDARDIZED": "ERROR_NOT_STANDARDIZED",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#TYPES#ERROR": "error",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#ERRORS#TYPES#WARNING": "warning",
      ...
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#NOTRUNTIMEVARIABLES#SUCCESS_FALSE": "success: false",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#NOTRUNTIMEVARIABLES#SUCCESS_TRUE": "success: true",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#PUBLIC#NOTRUNTIMEVARIABLES#ATHAND": "concerné(e)(s)",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#NOTRUNTIMEVARIABLES#PUBLIC#SUCCESS_FALSE": "success: false",
      "_LUTHERTS_ERROR_HANDLING#SHAREDVARIABLES#NOTRUNTIMEVARIABLES#PUBLIC#SUCCESS_TRUE": "success: true",
      "_LUTHERTS_ERROR_HANDLING#PUBLIC#RESOLVEDPUBLICDATA": "",
      "_LUTHERTS_ERROR_HANDLING#PUBLIC#MAKESUCCESSFALSETYPEERROR": "",
